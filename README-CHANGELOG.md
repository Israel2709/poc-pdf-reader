...
- Proyecto Vite + React inicializado con Tailwind CSS.
- Firebase configurado (app y Storage).
- Router con vistas `/pdfs` y `/upload`.
- Formulario para subir PDFs con drag & drop, validación y progreso.
